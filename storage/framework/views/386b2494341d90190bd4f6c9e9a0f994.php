...
<div <?php echo e($attributes->merge(['class' => "flex items-center gap-2 {$justifyClass}"])); ?>>
    <?php echo e($slot); ?>

</div>
<?php /**PATH D:\stk\stk-back\resources\views/components/table/actions.blade.php ENDPATH**/ ?>