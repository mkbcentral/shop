<div>
    <!--[if BLOCK]><![endif]--><?php if($showModal && $organization): ?>
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            <div class="relative transform overflow-hidden rounded-2xl bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 shadow-2xl transition-all w-full max-w-2xl">
                ...
                <div class="px-6 py-8">
                    ...
                    <div class="bg-slate-700/50 rounded-xl p-6 mb-6">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center py-2 border-b border-slate-600">
                                ...
                                <span class="text-white font-medium"><?php echo e($organization->name); ?></span>
                            </div>
                            
                            <div class="flex justify-between items-center py-2 border-b border-slate-600">
                                <span class="text-slate-400">Plan choisi</span>
                                <span class="text-indigo-400 font-medium">
                                    <?php echo e($planData['name'] ?? $organization->subscription_plan->label()); ?>
                            ...
                            <div class="flex justify-between items-center py-2">
                                ...
                                <span class="text-2xl font-bold text-emerald-400">
                                    <?php echo e(number_format($planData['price'] ?? 0, 0, ',', ' ')); ?> <?php echo e($currency); ?>/mois
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Features -->
                    <!--[if BLOCK]><![endif]--><?php if(!empty($planData['features'])): ?>
                    <div class="mb-6">
                        <h4 class="text-sm font-medium text-slate-400 mb-3">Ce qui est inclus :</h4>
                        <div class="grid grid-cols-2 gap-2">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = array_slice($planData['features'] ?? [], 0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center text-sm text-slate-300">
                                ...
                                <span class="truncate"><?php echo e($feature); ?></span>
                            </div>
                    ...
                    <button
                        ...
                        <span wire:loading.remove wire:target="processPayment" class="flex items-center justify-center">
                            ...
                            Procéder au paiement - <?php echo e(number_format($planData['price'] ?? 0, 0, ',', ' ')); ?> <?php echo e($currency); ?>
...
<?php /**PATH D:\stk\stk-back\resources\views/livewire/organization/payment-modal.blade.php ENDPATH**/ ?>