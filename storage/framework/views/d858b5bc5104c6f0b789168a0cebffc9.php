...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.button','data' => ['href' => ''.e(route('proformas.index')).'','wire:navigate' => true,'variant' => 'secondary','icon' => 'arrow-left']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('proformas.index')).'','wire:navigate' => true,'variant' => 'secondary','icon' => 'arrow-left']); ?>
            Retour
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                                ...
                                >
                                    <!--[if BLOCK]><![endif]--><?php if($this->hasResults): ?>
                                        <div class="px-4 py-3 bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200">
                                            <span class="text-xs font-bold text-gray-600 uppercase tracking-wider flex items-center gap-2">
                                                ...
                                                <?php echo e(count($this->searchResults)); ?> produit(s) trouvé(s)
                                            </span>
                                        </div>
                                        <div class="overflow-y-auto max-h-64">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->searchResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <button type="button"
                                                    ...
                                                    <div class="flex justify-between items-center gap-4">
                                                        ...
                                                        <div class="text-right flex-shrink-0">
                                                            <div class="text-sm font-bold text-indigo-600">
                                                                <?php echo e(number_format($result['price'], 0, ',', ' ')); ?> <span class="text-xs">CDF</span>
                                                            </div>
                                    ...
                                    <?php else: ?>
                                        <div class="px-6 py-10 text-center">
                                            ...
                                            <p class="text-xs text-gray-500 mt-1">pour "<span class="text-indigo-600 font-medium"><?php echo e($productSearch); ?></span>"</p>
                                        </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500"><?php echo e(count($items)); ?> article(s)</p>
                            </div>
                        </div>
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center gap-4 p-4 bg-gray-50 hover:bg-gray-100 rounded-xl transition-colors group">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <h4 class="font-semibold text-gray-900 truncate"><?php echo e($item['name']); ?></h4>
                                            <div class="flex items-center gap-3 mt-1 text-sm text-gray-500">
                                                ...
                                                <span>×</span>
                                                <span><?php echo e(number_format($item['unit_price'], 0, ',', ' ')); ?> CDF</span>
                                                <!--[if BLOCK]><![endif]--><?php if($item['discount'] > 0): ?>
                                                    <span class="text-red-500">-<?php echo e(number_format($item['discount'], 0, ',', ' ')); ?></span>
                                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            </div>
                                        </div>
                                        ...
                                        <div class="flex items-center gap-4">
                                            <div class="text-right">
                                                <div class="font-bold text-gray-900"><?php echo e(number_format($item['total'], 0, ',', ' ')); ?></div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div>
                            ...
                            <input wire:model="client_email" type="email" placeholder="client@example.com"
                                   class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all">
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['client_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <input wire:model="proforma_date" type="date"
                                   class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all">
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['proforma_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div>
                            ...
                            <input wire:model="valid_until" type="date"
                                   class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all">
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['valid_until'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <div class="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl shadow-sm border-2 border-indigo-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-4">
                        <div class="flex justify-between items-center pb-3 border-b border-indigo-200">
                            ...
                            <span class="text-base font-bold text-gray-900"><?php echo e(number_format($subtotal, 0, ',', ' ')); ?> <span class="text-sm text-gray-600">CDF</span></span>
                        </div>
                        
                        <div class="flex justify-between items-center pb-3 border-b border-indigo-200">
                            <span class="text-sm font-medium text-gray-700">Remises</span>
                            <span class="text-base font-bold text-red-600">-<?php echo e(number_format(collect($items)->sum('discount'), 0, ',', ' ')); ?> <span class="text-sm">CDF</span></span>
                        </div>
...
<?php /**PATH D:\stk\stk-back\resources\views/livewire/proforma/proforma-create.blade.php ENDPATH**/ ?>