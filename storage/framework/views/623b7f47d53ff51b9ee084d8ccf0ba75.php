...
<head>
    ...
    <title><?php echo e(config('app.name', 'ShopFlow')); ?> - Gestion Multi-Commerce</title>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-3594236008-0', $__slots ?? [], get_defined_vars());
    ...
    <nav class="relative z-10 px-6 py-4">
        <div class="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <span class="text-2xl font-bold logo-text"><?php echo e(config('app.name', 'ShopFlow')); ?></span>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn-secondary px-6 py-2.5 rounded-lg font-medium">
                        Tableau de bord
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn-secondary px-6 py-2.5 rounded-lg font-medium">
                        Connexion
                    </a>
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="btn-primary px-6 py-2.5 rounded-lg font-medium shadow-lg">
                            Créer un compte
                        </a>
                    <?php endif; ?>
                <?php endif; ?>
            ...
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div class="space-y-8">
                    <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-500/10 border border-indigo-500/20">
                        ...
                        <span class="text-sm text-indigo-300">Version <?php echo e(app()->version() ?? '1.0'); ?> disponible</span>
                    </div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="btn-primary px-8 py-4 rounded-xl font-semibold text-lg shadow-xl flex items-center gap-2">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('register')); ?>" class="btn-primary px-8 py-4 rounded-xl font-semibold text-lg shadow-xl flex items-center gap-2">
                                Commencer gratuitement
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                                </svg>
                            </a>
                            <a href="<?php echo e(route('login')); ?>" class="btn-secondary px-8 py-4 rounded-xl font-semibold text-lg flex items-center gap-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="device-laptop floating">
                        <div class="laptop-frame">
                            <div class="laptop-screen">
                                ...
                                <?php if(file_exists(public_path('images/mockup-desktop.png'))): ?>
                                    <img src="<?php echo e(asset('images/mockup-desktop.png')); ?>" alt="ShopFlow Dashboard">
                                <?php else: ?>
                        ...
                        <div class="device-phone floating-delay">
                            <div class="phone-frame">
                                ...
                                <div class="phone-screen">
                                    ...
                                    <?php if(file_exists(public_path('images/mockup-mobile.png'))): ?>
                                        <img src="<?php echo e(asset('images/mockup-mobile.png')); ?>" alt="ShopFlow Mobile">
                                    <?php else: ?>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
                <?php $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slug => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="pricing-card glass-card rounded-2xl p-6 relative group hover:scale-105 transition-transform duration-300
                        ...
                        <div class="space-y-5 <?php if($plan['is_popular'] ?? false): ?> pt-1 <?php endif; ?>">
                            <div>
                                <h3 class="text-lg font-semibold <?php if($plan['is_popular'] ?? false): ?> text-white <?php else: ?> text-slate-300 <?php endif; ?>">
                                ...
                                <p class="text-slate-500 text-sm mt-1">
                                    ...
                                    <?php elseif($slug === 'starter'): ?>
                                        Pour les petits commerces
                                    <?php elseif($slug === 'professional'): ?>
                                        Pour les PME
                                    <?php else: ?>
                            ...
                            <div class="flex items-baseline gap-1">
                                <span class="text-3xl font-bold"><?php echo e(number_format($plan['price'], 0, ',', ' ')); ?></span>
                                <span class="text-slate-400"><?php echo e($currency); ?>/mois</span>
                            </div>

                            <ul class="space-y-2.5 text-sm">
                                <?php $__currentLoopData = $plan['features'] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="flex items-center gap-2 <?php if($plan['is_popular'] ?? false): ?> text-slate-200 <?php else: ?> text-slate-300 <?php endif; ?>">
                            ...
                            <?php elseif($plan['is_popular'] ?? false): ?>
                                <a href="<?php echo e(route('register')); ?>" class="block w-full py-2.5 px-4 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-center font-medium text-sm hover:opacity-90 transition-opacity shadow-lg shadow-indigo-500/25">
                                    Choisir <?php echo e($plan['name']); ?>

                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('register')); ?>" class="block w-full py-2.5 px-4 rounded-xl border border-slate-600 text-center font-medium text-sm hover:bg-slate-700 transition-colors">
                                    <?php if($slug === 'free'): ?>
                                        Commencer
                                    <?php else: ?>
                                        Choisir <?php echo e($plan['name']); ?>
            ...
            <div class="glass-card rounded-3xl p-8 lg:p-12">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="pt-4">
                            <?php if(auth()->guard()->guest()): ?>
                                <a href="<?php echo e(route('register')); ?>" class="btn-primary inline-flex items-center gap-2 px-6 py-3 rounded-xl font-semibold">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(route('dashboard')); ?>" class="w-full btn-primary py-4 rounded-xl font-semibold text-center block">
                                    Accéder à mon espace
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="w-full btn-primary py-4 rounded-xl font-semibold text-center block">
                                    Se connecter
                                </a>
                                <?php if(Route::has('register')): ?>
                                    <a href="<?php echo e(route('register')); ?>" class="w-full btn-secondary py-4 rounded-xl font-semibold text-center block">
                                        Créer un compte
                                    </a>
                                <?php endif; ?>
                            <?php endif; ?>
        ...
        <div class="max-w-7xl mx-auto px-6 py-12">
            <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-lg font-semibold"><?php echo e(config('app.name', 'ShopFlow')); ?></span>
                </div>
                ...
                <div class="flex items-center gap-6 text-slate-400 text-sm">
                    ...
                    <span>•</span>
                    <span>© <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'ShopFlow')); ?></span>
                </div>

                <div class="flex items-center gap-2 text-sm">
                    <span class="text-slate-500">Développé par</span>
                    <a href="<?php echo e(config('app.developer_url', '#')); ?>" target="_blank" class="text-indigo-400 hover:text-indigo-300 font-medium transition-colors">
                        <?php echo e(config('app.developer_name', 'Africa Go Tech')); ?>
...
<?php /**PATH D:\stk\stk-back\resources\views/welcome.blade.php ENDPATH**/ ?>