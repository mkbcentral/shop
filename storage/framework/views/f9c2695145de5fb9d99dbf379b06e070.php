...
[$__name, $__params] = $__split('store.store-switcher');

$__html = app('livewire')->mount($__name, $__params, 'lw-1646146633-0', $__slots ?? [], get_defined_vars());
              ...
              <?php else: ?>
                  ...
                  <div
                      ...
                      <span class="hidden md:inline font-medium text-gray-900">
                          <?php echo e($currentStore?->name ?? 'Aucun magasin'); ?>
...
[$__name, $__params] = $__split('notifications.sales-notification-bell');

$__html = app('livewire')->mount($__name, $__params, 'lw-1646146633-1', $__slots ?? [], get_defined_vars());
...
[$__name, $__params] = $__split('stock.stock-notifications');

$__html = app('livewire')->mount($__name, $__params, 'lw-1646146633-2', $__slots ?? [], get_defined_vars());
...
<?php /**PATH D:\stk\stk-back\resources\views/components/header.blade.php ENDPATH**/ ?>