<div class="border-t-2 border-gray-200 bg-white px-3 py-2 space-y-2">
    ...
    <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-2 space-y-1">
        <div class="flex justify-between text-xs">
            ...
            <span class="font-bold text-gray-900"><?php echo e(number_format($subtotal, 0, ',', ' ')); ?></span>
        </div>
        <!--[if BLOCK]><![endif]--><?php if($discount > 0): ?>
            <div class="flex justify-between text-xs">
                <span class="text-green-600">Remise</span>
                <span class="font-bold text-green-600">-<?php echo e(number_format($discount, 0, ',', ' ')); ?></span>
            </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <!--[if BLOCK]><![endif]--><?php if($tax > 0): ?>
            <div class="flex justify-between text-xs">
                <span class="text-gray-600">Taxe</span>
                <span class="font-bold text-gray-900">+<?php echo e(number_format($tax, 0, ',', ' ')); ?></span>
            </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <div class="flex justify-between text-lg font-black pt-1 border-t border-gray-300">
            <span class="text-gray-900">TOTAL</span>
            <span class="text-indigo-600"><?php echo e(number_format($total, 0, ',', ' ')); ?></span>
        </div>
    </div>
    ...
    <!--[if BLOCK]><![endif]--><?php if($change > 0): ?>
        <div class="bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg p-2">
            <div class="flex justify-between items-center">
                ...
                <span class="text-xl font-black text-white"><?php echo e(number_format($change, 0, ',', ' ')); ?></span>
            </div>
        </div>
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <div class="flex gap-2">
        ...
        <button wire:click="processPaymentOnly" wire:loading.attr="disabled" wire:target="processPaymentOnly" <?php echo e($total <= 0 ? 'disabled' : ''); ?>
        ...
        <button wire:click="processPayment" wire:loading.attr="disabled" wire:target="processPayment" <?php echo e($total <= 0 ? 'disabled' : ''); ?>
    ...
    <!-- Receipt Button -->
    <!--[if BLOCK]><![endif]--><?php if($lastSaleId): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($showReceipt && $lastSaleId): ?>
            ...
            <div class="flex items-center justify-center min-h-screen p-4">
                ...
                <div class="relative bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-hidden">
                    ...
                    <div class="p-6 overflow-y-auto max-h-[60vh]">
                        <!--[if BLOCK]><![endif]--><?php if($this->lastSale): ?>
                            <?php echo $__env->make('livewire.pos.partials.receipt-preview-modal', [
...
<?php /**PATH D:\stk\stk-back\resources\views/livewire/pos/components/pos-payment-panel.blade.php ENDPATH**/ ?>