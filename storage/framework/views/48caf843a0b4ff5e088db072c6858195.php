            ...
            <div class="flex items-center justify-between">
                ...
                <!--[if BLOCK]><![endif]--><?php if($unreadCount > 0): ?>
                    <span class="px-3 py-1 bg-white/20 rounded-full text-white text-xs font-bold">
                        <?php echo e($unreadCount); ?> nouveau(x)
                    </span>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </div>
        </div>
        ...
        <div class="max-h-[400px] overflow-y-auto custom-scrollbar">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div wire:click="markAsRead('<?php echo e($notification->id); ?>')"
                    class="px-4 py-3 hover:bg-gray-50 cursor-pointer transition-colors border-b border-gray-50 <?php echo e($isUnread ? 'bg-indigo-50/50' : ''); ?>">
                    <div class="flex items-start gap-3">
                        <!-- Icon -->
                        <div class="flex-shrink-0 w-10 h-10 bg-gradient-to-br <?php echo e($colorClasses); ?> rounded-xl flex items-center justify-center shadow-lg">
                            <!--[if BLOCK]><![endif]--><?php switch($data['icon'] ?? 'bell'):
                                case ('cash'): ?>
                                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2">
                                <span class="text-xs font-semibold text-indigo-600 bg-indigo-100 px-2 py-0.5 rounded-full">
                                    <?php echo e($data['store_name'] ?? 'Magasin'); ?>
                            ...
                            <p class="text-sm text-gray-800 font-medium mt-1 line-clamp-2">
                                <?php echo e($data['message'] ?? 'Nouvelle notification'); ?>
...
<?php /**PATH D:\stk\stk-back\resources\views/livewire/notifications/sales-notification-bell.blade.php ENDPATH**/ ?>