        ...
        <div class="fixed inset-0 flex items-center justify-center p-4 pointer-events-none">
            <div x-show="show"
                ...
                <form wire:submit="save" class="flex flex-col flex-1 min-h-0" x-data="{
                    showDescription: <?php if ((object) ('showDescription') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showDescription'->value()); ?>')<?php echo e('showDescription'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showDescription'); ?>')<?php endif; ?>,
                    showImage: <?php if ((object) ('showImage') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showImage'->value()); ?>')<?php echo e('showImage'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showImage'); ?>')<?php endif; ?>,
                    showVariants: <?php if ((object) ('showVariants') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showVariants'->value()); ?>')<?php echo e('showVariants'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showVariants'); ?>')<?php endif; ?>
                }">
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <select wire:model.live="form.product_type_id" id="form.product_type_id"
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $productTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($type->id); ?>"><?php echo e($type->icon); ?>

                                                    <?php echo e($type->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                        </select>
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['form.product_type_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="form.cost_price" wire:model.live="form.cost_price"
                                            ...
                                            class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['form.cost_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="form.price" wire:model.live="form.price"
                                            step="0.01" min="0" placeholder="0"
                                            class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['form.price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <div>
                                        ...
                                        <input type="number" id="form.stock_alert_threshold"
                                            ...
                                            class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" />
                                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['form.stock_alert_threshold'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($form->price && $form->cost_price && floatval($form->cost_price) > 0): ?>
                                    <div
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span class="text-xl font-bold text-indigo-900">
                                                <?php echo e(number_format((($form->price - $form->cost_price) / $form->cost_price) * 100, 2)); ?>%
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <?php if (isset($component)) { $__componentOriginal30ff40e7bae7ed9bef74ef9950aa27dd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal30ff40e7bae7ed9bef74ef9950aa27dd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.optional-section','data' => ['title' => 'Description','show' => 'showDescription','gradientFrom' => 'green-500','gradientTo' => 'teal-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('optional-section'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Description','show' => 'showDescription','gradient-from' => 'green-500','gradient-to' => 'teal-600']); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginal30ff40e7bae7ed9bef74ef9950aa27dd)): ?>
<?php $attributes = $__attributesOriginal30ff40e7bae7ed9bef74ef9950aa27dd; ?>
<?php unset($__attributesOriginal30ff40e7bae7ed9bef74ef9950aa27dd); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal30ff40e7bae7ed9bef74ef9950aa27dd)): ?>
<?php $component = $__componentOriginal30ff40e7bae7ed9bef74ef9950aa27dd; ?>
<?php unset($__componentOriginal30ff40e7bae7ed9bef74ef9950aa27dd); ?>
<?php endif; ?>

                            <!-- Image Upload (Optional) -->
                            <?php if (isset($component)) { $__componentOriginal30ff40e7bae7ed9bef74ef9950aa27dd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal30ff40e7bae7ed9bef74ef9950aa27dd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.optional-section','data' => ['title' => 'Image','show' => 'showImage','gradientFrom' => 'pink-500','gradientTo' => 'rose-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('optional-section'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Image','show' => 'showImage','gradient-from' => 'pink-500','gradient-to' => 'rose-600']); ?>
                                <div x-data="{
                                    isDragging: false,
                                    handleDragOver(e) {
                                        e.preventDefault();
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($form->image || $currentImage): ?>
                                        ...
                                        <div class="relative group">
                                            <div
                                                ...
                                                <img src="<?php echo e($form->image ? $form->image->temporaryUrl() : asset('storage/' . $currentImage)); ?>"
                                                ...
                                                <div
                                                    ...
                                                    <div class="absolute bottom-0 left-0 right-0 p-4 text-white">
                                                        <p class="text-sm font-medium">
                                                            <?php echo e($form->image ? 'Nouvelle image' : 'Image actuelle'); ?>
...
<?php endif; ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($form->product_type_id): ?>
                                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('product.dynamic-attributes', ['productTypeId' => $form->product_type_id]);

$__html = app('livewire')->mount($__name, $__params, 'dynamic-attrs-' . $form->product_type_id, $__slots ?? [], get_defined_vars());
...
?>
                            ...
                            <!-- Variant Preview -->
                            <!--[if BLOCK]><![endif]--><?php if($totalVariantsCount > 0): ?>
                                    ...
                                    <div class="mb-4">
                                        <div class="inline-flex items-center px-4 py-2 bg-green-100 border border-green-300 rounded-lg">
                                            ...
                                            <span class="text-sm font-bold text-green-700">
                                                <?php echo e($totalVariantsCount); ?> variante(s) seront générées automatiquement
                                            </span>
                                        </div>
                                    </div>

                                    <!--[if BLOCK]><![endif]--><?php if(count($variantPreview) > 0): ?>
                                        <div class="space-y-2">
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2 max-h-60 overflow-y-auto">
                                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $variantPreview; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $variant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="flex items-center p-3 bg-white rounded-lg border border-green-200 shadow-sm hover:shadow-md transition-shadow duration-200">
                                                        ...
                                                        <div class="flex-1 min-w-0">
                                                            <p class="text-sm font-medium text-gray-900 truncate">
                                                                <?php echo e(implode(' • ', array_map(fn($k, $v) => "$k: $v", array_keys($variant), $variant))); ?>
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($totalVariantsCount > count($variantPreview)): ?>
                                                <p class="text-xs text-gray-500 mt-2 text-center">
                                                    ... et <?php echo e($totalVariantsCount - count($variantPreview)); ?> autre(s) variante(s)
                                                </p>
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        </div>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <?php if (isset($component)) { $__componentOriginal30ff40e7bae7ed9bef74ef9950aa27dd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal30ff40e7bae7ed9bef74ef9950aa27dd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.optional-section','data' => ['title' => 'Variantes','show' => 'showVariants','gradientFrom' => 'blue-500','gradientTo' => 'cyan-600']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('optional-section'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Variantes','show' => 'showVariants','gradient-from' => 'blue-500','gradient-to' => 'cyan-600']); ?>
                                <div class="space-y-3">
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center justify-between mb-2">
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if(count($variants) > 1): ?>
                                                    <button type="button"
                                                        wire:click="removeVariant(<?php echo e($index); ?>)"
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                                                <input wire:model="variants.<?php echo e($index); ?>.size" type="text"
                                                    placeholder="Taille"
                                                ...
                                                <input wire:model="variants.<?php echo e($index); ?>.color" type="text"
                                                    placeholder="Couleur"
                                                    class="block w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" />
                                                <input wire:model="variants.<?php echo e($index); ?>.sku" type="text"
                                                    placeholder="SKU"
                                                    class="block w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" />
                                            </div>

                                            <div class="grid grid-cols-2 md:grid-cols-4 gap-2 mt-2">
                                                <input wire:model="variants.<?php echo e($index); ?>.stock_quantity"
                                                    type="number" min="0" placeholder="Qté"
                                                    class="block w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" />
                                                <input wire:model="variants.<?php echo e($index); ?>.additional_price"
                                                    type="number" step="0.01" placeholder="Prix +"
                                                    class="block w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" />
                                                <input wire:model="variants.<?php echo e($index); ?>.low_stock_threshold"
                                                    type="number" min="0" placeholder="Seuil bas"
                                                    class="block w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition" />
                                                <input wire:model="variants.<?php echo e($index); ?>.min_stock_threshold"
                        ...
                        <div
                            ...
                            <button type="submit" wire:loading.attr="disabled"
                                ...
                                <span wire:loading.remove wire:target="save">
                                    <?php echo e($productId ? 'Modifier' : 'Créer'); ?>
...
<?php /**PATH D:\stk\stk-back\resources\views/livewire/product/product-modal.blade.php ENDPATH**/ ?>