                        ...
                        <!--[if BLOCK]><![endif]--><?php if($form->payment_status === 'partial' || $form->payment_status === 'paid'): ?>
                            <div class="p-4 bg-amber-50 rounded-xl border border-amber-200">
                                <label class="block text-sm font-semibold text-amber-800 mb-2">
                                    💰 Montant <?php echo e($form->payment_status === 'paid' ? 'total payé' : 'déjà versé'); ?>

                                </label>
                                <input type="number" wire:model.live="form.paid_amount" step="0.01" min="0"
                                       placeholder="<?php echo e($form->payment_status === 'paid' ? 'Montant total' : 'Montant partiel'); ?>"
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <div class="flex justify-between items-center text-gray-600">
                                ...
                                <span class="font-semibold text-gray-900"><?php echo e(number_format($subtotal, 0, ',', ' ')); ?> CDF</span>
                            </div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(floatval($form->discount) > 0): ?>
                                <div class="flex justify-between items-center text-red-600">
                                    <span>- Remise</span>
                                    <span><?php echo e(number_format($form->discount, 0, ',', ' ')); ?> CDF</span>
                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            <!--[if BLOCK]><![endif]--><?php if(floatval($form->tax) > 0): ?>
                                <div class="flex justify-between items-center text-gray-600">
                                    <span>+ Taxe</span>
                                    <span><?php echo e(number_format($form->tax, 0, ',', ' ')); ?> CDF</span>
                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <div class="border-t border-gray-200 pt-4">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-2xl font-black text-indigo-600"><?php echo e(number_format($total, 0, ',', ' ')); ?> <span class="text-base font-normal">CDF</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 p-4">
                        <div class="grid grid-cols-2 gap-4 text-center">
                            <div class="p-3 bg-gray-50 rounded-lg">
                                <div class="text-2xl font-bold text-gray-900"><?php echo e(count($items)); ?></div>
                                <div class="text-xs text-gray-500">Articles</div>
                            </div>
                            <div class="p-3 bg-gray-50 rounded-lg">
                                <div class="text-2xl font-bold text-gray-900"><?php echo e(array_sum(array_column($items, 'quantity'))); ?></div>
...
<?php /**PATH D:\stk\stk-back\resources\views/livewire/sale/sale-create.blade.php ENDPATH**/ ?>