...
<?php $component->withAttributes([]); ?>
    <?php $__env->startSection('title', 'Accès non autorisé'); ?>
    ...
    <div class="flex items-center justify-center min-h-[calc(100vh-200px)]">
        <div class="max-w-lg w-full text-center">
            ...
            <p class="text-gray-600 mb-8 leading-relaxed max-w-md mx-auto">
                <?php echo e($exception->getMessage() ?: 'Désolé, vous n\'avez pas les droits nécessaires pour accéder à cette page. Si vous pensez qu\'il s\'agit d\'une erreur, veuillez contacter votre administrateur.'); ?>
            ...
            <?php if(auth()->guard()->check()): ?>
                <div class="mb-8 inline-flex items-center gap-2 px-4 py-2 bg-gray-100 rounded-full text-sm text-gray-600">
                    ...
                    <?php if(auth()->user()->roles->isNotEmpty()): ?>
                        ...
                        <span class="text-indigo-600 font-medium"><?php echo e(auth()->user()->roles->pluck('name')->join(', ')); ?></span>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\stk\stk-back\resources\views/errors/403.blade.php ENDPATH**/ ?>