...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['adjustingVariant' => null, 'newQuantity' => null]));
...
foreach (array_filter((['adjustingVariant' => null, 'newQuantity' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<!-- Adjust Stock Modal -->
<div
    x-data="{ show: <?php if ((object) ('showAdjustModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showAdjustModal'->value()); ?>')<?php echo e('showAdjustModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showAdjustModal'); ?>')<?php endif; ?> }"
    x-show="show"
    x-cloak
                ...
                <div class="flex items-start justify-between mb-4 pb-4 border-b border-gray-200">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($adjustingVariant): ?>
                                <p class="text-sm text-gray-500 mt-1">
                                    <?php echo e($adjustingVariant->product->name); ?>

                                    <!--[if BLOCK]><![endif]--><?php if($adjustingVariant->size || $adjustingVariant->color): ?>
                                        - <?php echo e($adjustingVariant->getVariantName()); ?>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 mb-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900"><?php echo e($adjustingVariant->stock_quantity); ?></p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-500">Seuil d'Alerte</p>
                                <p class="text-lg font-semibold text-gray-700"><?php echo e($adjustingVariant->low_stock_threshold); ?></p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                            >
                            <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['newQuantity'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <!-- Impact Preview -->
                        <!--[if BLOCK]><![endif]--><?php if($adjustingVariant && $newQuantity !== null && $newQuantity != $adjustingVariant->stock_quantity): ?>
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                <p class="text-sm text-blue-800">
                                    <span class="font-semibold">Impact:</span>
                                    <!--[if BLOCK]><![endif]--><?php if($newQuantity > $adjustingVariant->stock_quantity): ?>
                                        <span class="text-green-600">+<?php echo e($newQuantity - $adjustingVariant->stock_quantity); ?></span>
                                    <?php else: ?>
                                        <span class="text-red-600"><?php echo e($newQuantity - $adjustingVariant->stock_quantity); ?></span>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    unité(s)
                                </p>
                            </div>
...
<?php /**PATH D:\stk\stk-back\resources\views/components/stock/adjust-modal.blade.php ENDPATH**/ ?>