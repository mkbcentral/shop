<div class="space-y-6"
                ...
                @forelse ($attributes as $attribute)
                    <x-table.row wire:key="attribute-{{ $attribute->id }}">
                        ...
                        <x-table.cell align="center">
                            <x-table.actions>
                                <x-table.action-button @click="$wire.openEditModal({{ $attribute->id }})" color="indigo">
    ...
    >
        ...
        <form wire:submit.prevent="save">
            <div class="p-6 space-y-5 overflow-y-auto" style="max-height: calc(90vh - 180px);">
            ...
            <div class="flex-shrink-0 bg-gray-50 px-6 py-4 flex items-center justify-end space-x-3 border-t border-gray-200 rounded-b-2xl">
                <x-form.button variant="secondary" type="button" @click="showModal = false">
                    Annuler
                </x-form.button>
