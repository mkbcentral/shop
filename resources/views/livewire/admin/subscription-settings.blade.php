    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between mt-4">
            ...
            <div class="flex items-center gap-3">
                <a href="{{ route('admin.available-features') }}"
                    class="group inline-flex items-center px-4 py-2.5 text-sm font-semibold text-indigo-600 bg-white hover:bg-indigo-50 border-2 border-indigo-200 hover:border-indigo-300 rounded-xl transition-all shadow-sm hover:shadow-md">
