<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <!-- Loading Overlay -->
    <div wire:loading wire:target="handleTabChange,handlePeriodChange" 
         class="absolute inset-0 bg-white/90 backdrop-blur-sm z-40 flex items-center justify-center rounded-xl">
    ...
    <div class="space-y-6 relative min-h-[400px]">
        ...
        @if ($activeTab === 'overview')
            <div class="space-y-6" wire:key="overview-tab">
                <!-- Main Stats Cards -->
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <livewire:admin.components.stats-card
                        ...
                        icon='<svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /></svg>'
                        footerLabel="Actifs"
        ...
        <!-- Users Tab -->
        @if ($activeTab === 'users')
            <div class="bg-white rounded-xl shadow-sm border border-gray-200" wire:key="users-tab">
        ...
        @if ($activeTab === 'organizations')
            <div class="bg-white rounded-xl shadow-sm border border-gray-200" wire:key="organizations-tab">
                <div class="p-6 border-b border-gray-200">
                    <div class="flex flex-col sm:flex-row gap-4">
                        <div class="flex-1">
