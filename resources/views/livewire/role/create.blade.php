<div>
    <x-slot name="header">
        <x-breadcrumb
            :items="[['label' => 'Accueil', 'url' => route('dashboard')], ['label' => 'Rôles', 'url' => route('roles.index')], ['label' => 'Nouveau Rôle']]" />
    </x-slot>
    ...
    <div class="mt-4">
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-gray-500 mt-1">Définissez le nom, la description et les permissions du rôle</p>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="slug" wire:model="slug"
                            class="block w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 @error('slug') border-red-500 @enderror">
                        @error('slug')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
