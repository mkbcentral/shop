<div>
            ...
            <div class="flex-1">
                ...
                <div class="mt-4 space-y-2">
                    ...
                    <div class="flex items-center text-sm text-gray-600">
                        ...
                        <span>Utilisateurs : <strong>{{ $organization->users()->count() }} / {{ $organization->max_users ?? '∞' }}</strong></span>
                    </div>
                </div>
            </div>
    ...
    <!-- Subscribe Modal -->
    <x-modal wire:model="showSubscribeModal" max-width="2xl">
        <div class="p-6">
    ...
    <!-- Reactivate Modal -->
    <x-modal wire:model="showReactivateModal" max-width="lg">
        <div class="p-6">
    ...
    <!-- Renew Modal -->
    <x-modal wire:model="showRenewModal" max-width="lg">
        <div class="p-6">
            <div class="flex items-center mb-4">
    ...
    <x-modal wire:model="showCancelModal" max-width="lg">
        <div class="p-6">
            <div class="flex items-center mb-4">
