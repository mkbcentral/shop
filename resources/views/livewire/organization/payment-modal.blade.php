                                    ...
                                    <div class="flex-1">
                                        ...
                                        <div class="mt-3 flex flex-wrap gap-2">
                                            @if($paymentStatus === 'pending' && $pendingTransactionId)
                                                <button wire:click="confirmPaymentManually" class="inline-flex items-center px-3 py-1.5 text-xs font-medium rounded-lg text-white bg-green-600 hover:bg-green-700 transition-colors">
