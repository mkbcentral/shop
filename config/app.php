...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | These values are used to display the developer information in the
    | application footer or other UI elements where credit is given.
    |
    */

    'developer_name' => env('DEVELOPER_NAME'),
    'developer_url' => env('DEVELOPER_URL'),
